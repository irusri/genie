...
<html lang="en"> 
   <head>
      <?php
         ...
         <base href='$hostname'>
         <link rel='stylesheet' href='themes/".$wCMS->config->themeSelect."/css/style.css'>
		  <link rel='stylesheet' href='themes/".$wCMS->config->themeSelect."/css/hint.min.css'>
   ...
   <body>
      ...
      <div id="body_main_div" style="width:100%;">
         ...
         <header>
            ...
            onClick="location.href='<?php echo $c['hostname']?>';" src="themes/<?php echo $wCMS->config->themeSelect?>/images/logo2.png"/>
<?php  if(is_dir('plugins/autocomplete')==true){  include_once("plugins/autocomplete/autocompletesearch2.php");}?> 
         ...
         <div id="bg_content" style="width:86%;margin-left: 8%;margin-right: 6%;background-color:#FFF;background:#FFF;">
               ...
               <?php echo '<ul class="egmenu">'; menu();echo '</ul>';?>
            </nav>

         <?php if($wCMS->config->loggedIn) {settings();}?>
         <div class="clear"></div>
         <?php
